...
# --- Роли, которые можно купить в магазине "снятие с себя" ---
# Покупается командой /removerole. Чтобы добавить ещё одну роль —
# просто допишите новую строку сюда: <ID_РОЛИ>: {"name": "...", "price": ...}.
REMOVABLE_ROLES: dict[int, dict] = {
    1541430133649449051: {"name": "Роль (бонусная #1)", "price": 200},
    1541430309487255552: {"name": "Роль (бонусная #2)", "price": 200},
}
